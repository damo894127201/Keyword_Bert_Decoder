...
if __name__ == '__main__':
    ...
    for iter, (batch_x,batch_y,batch_source_lens,batch_target_lens,batch_keyword,batch_keyword_lens) in enumerate(loader):
        ...
        batch_keyword_lens = torch.as_tensor(batch_keyword_lens)
        # 预测结果和相应时刻的注意力权重
        results, attention_weights = model.BatchSample(batch_x,batch_source_lens,batch_keyword,batch_keyword_lens)
